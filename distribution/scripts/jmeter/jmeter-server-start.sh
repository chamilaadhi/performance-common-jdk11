...
export JVM_ARGS="-Xms$jmeter_heap_size -Xmx$jmeter_heap_size -Xloggc:$gc_log_file -Xlog:gc*,safepoint,gc+heap=trace:file=$gc_log_file:uptime,utctime,level,tags $jmeter_flags"
